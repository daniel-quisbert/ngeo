...
ngeo.bboxQueryDirective = function(ngeoQuery) {
  return {
    ...
    link: function(scope, elem, attrs) {
       ...
       * @type {ol.Map}
       */
      let map = scope.$eval(attrs['ngeoBboxQueryMap']);

      let interaction = new ol.interaction.DragBox({
       ...
       */
      let handleBoxEnd = function(evt) {
        let extent = interaction.getGeometry().getExtent();
