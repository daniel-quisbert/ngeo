...
app.MainController = function(ngeoToolActivateMgr) {
  ...
  let createPointToolActivate = new ngeo.ToolActivate(
    this,
    'createPointActive'
  );
  ...
  let createLineStringToolActivate = new ngeo.ToolActivate(
    this,
  ...
  let createPolygonToolActivate = new ngeo.ToolActivate(
    this,
    'createPolygonActive'
  );
  ngeoToolActivateMgr.registerTool(
