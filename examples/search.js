...
app.SearchController.prototype.createAndInitBloodhound_ = function(ngeoSearchCreateGeoJSONBloodhound) {
  let url = 'https://geomapfish-demo.camptocamp.net/2.1/wsgi/fulltextsearch?query=%QUERY';
  let bloodhound = ngeoSearchCreateGeoJSONBloodhound(
...
app.SearchController.select_ = function(event, suggestion, dataset) {
  ...
  let source = this.vectorLayer_.getSource();
  source.clear(true);
