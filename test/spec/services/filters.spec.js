...
describe('ngeo.Filters', function() {
  ...
  it('Ngeo Unit Prefix', function() {
    let unitPrefix = $filter('ngeoUnitPrefix');
    ...
    expect(unitPrefix(1e+19, 'm')).toBe('10,000\u00a0Pm');
  ...
  it('Ngeo Number coordinates', function() {
    let ngeoNumberCoordinates = $filter('ngeoNumberCoordinates');
  ...
  it('Ngeo DMS coordinates', function() {
    let ngeoDMSCoordinates = $filter('ngeoDMSCoordinates');
    let co = [7.1234, 46.9876];
