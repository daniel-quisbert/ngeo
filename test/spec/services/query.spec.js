...
describe('ngeo.Query', function() {
  ...
  describe('Issue requests', function() {
    ...
    beforeEach(function() {
      ...
      let projection = ol.proj.get('EPSG:21781');
    ...
    it('Issue request with one source', function() {
      let coordinate = [499200, 130000.00000000003];
      ngeoQuery.addSource({
        id: busStopSourceId,
        layer: busStopLayer
      });
    ...
    it('Issue request with two sources', function() {
      let coordinate = [533800, 153000.00000000003];
      ngeoQuery.addSource({
        id: busStopSourceId,
        layer: busStopLayer
      });
    ...
    describe('#getQueryableSources_', function() {
      it('gets sources for GetFeatureInfo requests', function() {
        ...
        let queryableSources = ngeoQuery.getQueryableSources_(map, false);
      ...
      it('gets sources for GetFeature requests', function() {
        ...
        let queryableSources = ngeoQuery.getQueryableSources_(map, true);
