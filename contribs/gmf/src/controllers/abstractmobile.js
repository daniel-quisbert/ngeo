...
gmf.AbstractMobileController = function(config, $scope, $injector) {
  ...
  let positionFeatureStyle = config.positionFeatureStyle || new ol.style.Style({
  ...
  let accuracyFeatureStyle = config.accuracyFeatureStyle || new ol.style.Style({
  ...
  let dragEl = document.querySelector('main');
  let handleEl = document.querySelector('main .overlay');
  /**
  ...
  goog.events.listen(this.dragger_, 'end', (function(e) {
    ...
    let deltaX = this.dragger_.limitX(this.dragger_.deltaX);
