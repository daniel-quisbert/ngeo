...
gmf.MobileNavController.prototype.init = function(element) {
  let cls = gmf.MobileNavController.ClassName_;
  ...
  element.find('[data-toggle=slide-in]').on('click', function(evt) {
    ...
    let slideOut = $(evt.currentTarget).parents('.' + cls.SLIDE);
    ...
    // element to slide in
    let slideIn = $($(evt.currentTarget).attr('data-target'));
