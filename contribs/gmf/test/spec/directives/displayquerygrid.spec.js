 ...
 */
let compareGridData = function(data, expectedData) {
...
describe('gmf.displayquerygridDirective', function() {
  ...
  describe('#updateData_', function() {
    ...
    it('deals with a single source', function() {
      ...
      let featuresForSource = queryGridController.featuresForSources_['123'];
      expect(Object.keys(featuresForSource).length).toBe(2);

      let gridSource = queryGridController.gridSources['123'];
      expect(gridSource).toBeDefined();

      let gridConfig = gridSource.configuration;
    ...
    it('deals with multiple sources', function() {
      ...
      // grid source 1
      let gridSource1 = queryGridController.gridSources['123'];
      expect(gridSource1).toBeDefined();

      let gridConfig1 = gridSource1.configuration;
      let expectedGridData1 = [
        {
          'osm_id': 1234,
          'name': 'A'
        },
      ...
      // grid source 2
      let gridSource2 = queryGridController.gridSources['234'];
      expect(gridSource2).not.toBeDefined();

      // grid source 3
      let gridSource3 = queryGridController.gridSources['345'];
      expect(gridSource3).toBeDefined();

      let gridConfig3 = gridSource3.configuration;
      let expectedGridData3 = [
        {
          'id': 1234,
          'label': 'C'
        }
    ...
    it('deals with sources with too many features', function() {
      ...
      // grid source 2
      let gridSource2 = queryGridController.gridSources['345'];
    ...
    it('merges sources', function() {
      ...
      // merged source
      let gridSource1 = queryGridController.gridSources['merged_source'];
      expect(gridSource1).toBeDefined();
  ...
  describe('#selectTab', function() {
    ...
    it('remembers selected rows when switching tabs', function() {
      let gridSource1 = queryGridController.gridSources['123'];
      let row1 = gridSource1.configuration.data[0];
